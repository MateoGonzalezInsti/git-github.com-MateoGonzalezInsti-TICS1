...
class Pycalc(Frame):
    ...
    def createWidgets(self):
        ...
        self.fourButton = Button(self, font=("Arial", 12), fg='black', text="4", highlightbackground='black', command=lambda: self.append("4"))
        self.fourButton.grid(row=3, column=0, sticky="nsew")
        self.fiveButton = Button(self, font=("Arial", 12), fg='black', text="5", highlightbackground='black', command=lambda: self.append("5"))
        self.fiveButton.grid(row=3, column=1, sticky="nsew")
        self.sixButton = Button(self, font=("Arial", 12), fg='black', text="6", highlightbackground='black', command=lambda: self.append("6"))
        ...
        self.oneButton = Button(self, font=("Arial", 12), fg='black', text="1", highlightbackground='black', command=lambda: self.append("1"))
        self.oneButton.grid(row=4, column=0, sticky="nsew")
        self.twoButton = Button(self, font=("Arial", 12), fg='black', text="2", highlightbackground='black', command=lambda: self.append("2"))
        self.twoButton.grid(row=4, column=1, sticky="nsew")
        self.threeButton = Button(self, font=("Arial", 12), fg='black', text="3", highlightbackground='black', command=lambda: self.append("3"))
        ...
        self.zeroButton = Button(self, font=("Arial", 12), fg='black', text="0", highlightbackground='black', command=lambda: self.append("0"))
