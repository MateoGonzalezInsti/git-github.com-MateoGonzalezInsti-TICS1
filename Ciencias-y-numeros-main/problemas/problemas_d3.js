function encontrar_problemas_d3() {
...
//problemas
{
    //mates
    {
        function problema_d3_p1() {
            //variables
            const cantidad_objetos = Math.trunc(Math.random() * 50 + 10);
            const dinero_objeto = Math.trunc(Math.random() * 20 + 1);
            //decidir indioma
            let texto_problema = "";
            if (idioma == 0) {
